...
public class WinScreen : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		GUI.Label(new Rect(Screen.width / 2.8f, Screen.height / 2.8f, Screen.width / 2.5f, Screen.height / 10), "yOU WIN", gameOver);
		GUI.Label(new Rect(Screen.width / 3.2f, Screen.height / 2.25f, Screen.width / 2.5f, Screen.height / 10), "thAnks For plAying", thankYou);
