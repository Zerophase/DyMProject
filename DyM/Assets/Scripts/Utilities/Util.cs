...
namespace Assets.Scripts.Utilities
{
	public static class Util
	{
		...
		private static void sweptBroadPhaseBox(Box3D box, PhysicsMediator physicsMediator)
		{
			...
			//Debug.Log("y Velocity: " + box.yVelocity);
			Debug.DrawLine(new Vector3(broadPhaseBox.xMin, broadPhaseBox.yMin, broadPhaseBox.zMin), 
				new Vector3(broadPhaseBox.xMin, broadPhaseBox.YMax, broadPhaseBox.zMin), Color.magenta, 1f);
			//TO XMAX
			Debug.DrawLine(new Vector3(broadPhaseBox.xMin, broadPhaseBox.yMin, broadPhaseBox.zMin), 
				new Vector3(broadPhaseBox.XMax, broadPhaseBox.yMin, broadPhaseBox.zMin), Color.magenta, 1f);
			//TO ZMAX
			Debug.DrawLine(new Vector3(broadPhaseBox.xMin, broadPhaseBox.yMin, broadPhaseBox.zMin), 
				new Vector3(broadPhaseBox.xMin, broadPhaseBox.yMin, broadPhaseBox.ZMax), Color.magenta, 1f);
		}
        ...
        private static float sweptAABB(Box3D b1, Box3D b2, out float normalX, out float normalY, out float normalZ)
        {
            ...
            {
				yInvEntry = b1.YMax - b2.yMin;
				yInvExit = b1.yMin - b2.YMax;
